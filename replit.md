...
- **Serves**: Web application UI
- **API Proxy**: Requests to `/api/*` are proxied to backend on port 8000
...
## Recent Changes (October 2025 Migration)
- ✅ Migrated from Docker to native Replit environment
- ✅ Configured PostgreSQL via Replit database service
- ✅ Installed Redis as system dependency
- ✅ Created backend startup script with environment configuration
- ✅ Fixed frontend TypeScript issues (@types/react-dom)
- ✅ Configured API proxy from frontend to backend
- ✅ Set up dual workflows (backend + frontend)
- ✅ Created admin user with custom credentials (admin/dashboard)
