    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('super_admin', 'Super Admin'), ('operator', 'Operator'), ('viewer', 'Viewer')], default='viewer', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('credential_type', models.CharField(choices=[('ssh_key', 'SSH Key'), ('password', 'Password'), ('api_token', 'API Token')], max_length=20)),
